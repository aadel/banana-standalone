module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: 'src/vendor/jquery/jquery-3.4.1.js', included: true},
      ...
      {pattern: 'src/vendor/angular/angular-animate.min.js', included: false},
      {pattern: 'src/vendor/angular/angular-strap.min.js', included: false},
      {pattern: 'src/vendor/angular/angular-strap.tpl.min.js', included: false},
      {pattern: 'src/vendor/angular/angular-dragdrop.js', included: false},
      {pattern: 'src/vendor/bootstrap/bootstrap.min.js', included: false},
